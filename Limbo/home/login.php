...
<body class="main-layout contineer_page" style="background-image: url('images/i3.jpeg'); background-repeat:repeat-x;">
  <!-- loader  -->
  <div class="loader_bg">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12" style="color: white;"><br>
                <form action="../db/submit-login.php" method="post">
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Enter your email</label>
                      <input type="email" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                      <div id="emailHelp" class="form-text">Carefull who you share it with, hehe.</div>
                    </div>
                    <div class="mb-3">
