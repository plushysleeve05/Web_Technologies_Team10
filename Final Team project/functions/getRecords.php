...
function fetchRowsFromDatabase() {
    ...
    // Prepare SQL query
    $query = "SELECT SongID, Title, ReleaseDate, Genre, Album, ArtistName, GeneralThoughts, LinkToSong FROM song";
...
function generateTableRow($rowData) {
    return "<tr>" .
        ...
        "<td><a href='{$rowData['LinkToSong']}' target='_blank'>Listen</a></td>" .
        "</tr>";
}
